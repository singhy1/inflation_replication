...
data_cps <- read_dta("C:/Users/singhy/Desktop/Chicago/cps_data/inflation/temp/cps_basic_monthly_matched.dta")
...
# ORG 
org_wage_1 <- get_worker_earn_q(data_cps, 1)
org_wage_2 <- get_worker_earn_q(data_cps, 2)
org_wage_3 <- get_worker_earn_q(data_cps, 3)
org_wage_4 <- get_worker_earn_q(data_cps, 4)
...
for (year in years) {
  ...
  for (month in months) {
    ...
    # ORG 
    ee_org_wage_1 <- get_J2J(org_wage_1, year, month)
    ee_org_wage_2 <- get_J2J(org_wage_2, year, month)
    ee_org_wage_3 <- get_J2J(org_wage_3, year, month)
    ee_org_wage_4 <- get_J2J(org_wage_4, year, month)
    ...
    # ORG 
    eu_org_wage_1 <- get_E2U(org_wage_1, year, month)
    eu_org_wage_2 <- get_E2U(org_wage_2, year, month)
    eu_org_wage_3 <- get_E2U(org_wage_3, year, month)
    eu_org_wage_4 <- get_E2U(org_wage_4, year, month)
    ...
    ue_org_wage_1 <- get_U2E(org_wage_1, year, month)
    ue_org_wage_2 <- get_U2E(org_wage_2, year, month)
    ue_org_wage_3 <- get_U2E(org_wage_3, year, month)
    ue_org_wage_4 <- get_U2E(org_wage_4, year, month)
    ...
    transition_rates <- rbind(transition_rates, data.frame(
      ...
      # ORG 
      ee_org_wage_1= ee_org_wage_1, 
      ee_org_wage_2= ee_org_wage_2,
      ee_org_wage_3= ee_org_wage_3,
      ee_org_wage_4= ee_org_wage_4,
      ...
      eu_quits_org_wage_1 = eu_org_wage_1$E2U_quits, 
      eu_layoffs_org_wage_1 = eu_org_wage_1$E2U_layoffs,
      eu_other_org_wage_1 = eu_org_wage_1$E2U_other, 
      
      eu_quits_org_wage_2 = eu_org_wage_2$E2U_quits, 
      eu_layoffs_org_wage_2 = eu_org_wage_2$E2U_layoffs,
      eu_other_org_wage_2 = eu_org_wage_2$E2U_other, 
      
      eu_quits_org_wage_3 = eu_org_wage_3$E2U_quits, 
      eu_layoffs_org_wage_3 = eu_org_wage_3$E2U_layoffs,
      eu_other_org_wage_3 = eu_org_wage_3$E2U_other, 
      
      eu_quits_org_wage_4 = eu_org_wage_4$E2U_quits, 
      eu_layoffs_org_wage_4 = eu_org_wage_4$E2U_layoffs,
      eu_other_org_wage_4 = eu_org_wage_4$E2U_other, 
      ...
      # ORG 
      ue_org_wage_1 = ue_org_wage_1, 
      ue_org_wage_2 = ue_org_wage_2, 
      ue_org_wage_3 = ue_org_wage_3, 
      ue_org_wage_4 = ue_org_wage_4, 
...
write_dta(transition_rates, 
          "C:/Users/singhy/Desktop/Chicago/cps_data/inflation/output/data/job_flow.dta")
