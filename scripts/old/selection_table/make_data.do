...
preserve 
import delimited "$proj_dir/data/raw/dingelneiman/onet_wfh_code.csv", clear 
rename occ_code oes_occ_code 
tempfile onet_temp
save `onet_temp'
restore

use "$proj_dir/data/raw/atl_fed/atl_fed_wage_raw.dta", clear
...
save "$proj_dir/data/processed/make_selection_table.dta", replace 
