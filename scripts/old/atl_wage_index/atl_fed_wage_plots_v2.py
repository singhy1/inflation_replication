...
final.to_csv(f"{output_dir}/data/real_wage_figures_v2.csv", index = False)
...
plt.tight_layout()  
plt.savefig(f"{output_dir}/figures/wage_index_trends_long_v2.pdf")
...
final = wage_data[main]
final.to_csv(f"{output_dir}/data/wage_data_00_24_v2.csv", index=False)
