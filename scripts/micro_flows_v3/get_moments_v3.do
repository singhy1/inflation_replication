...
use "$temp_dir\gross_flows_v3.dta", clear
...
* EU and UE 
preserve 
import delimited "$output_dir\data\shimer_decomposition_data.csv", clear
...
* ee average 
preserve 
import delimited "$output_dir/data/ee_monthly.csv", clear
...
describe
export delimited using "$output_dir/data/flow_moments_v3.csv", replace nolabel 